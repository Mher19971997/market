<template>
    <div class="input-block">
        <svg v-if="UIType === 'search'" class="input-block__icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
        ...
        <textarea class="input-block__input" name="" id="" cols="30" rows="10" :aria-placeholder="placeholder" :type="type"
